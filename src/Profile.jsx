                ...
                <div name='profile' className='m-10 lg:m-0 max-w-fit bg-gray-50 dark:bg-zinc-800 rounded-3xl'>
                    <div className="grid container mx-auto px-4 py-8 md:grid-cols-3 md:gap-6">
                        ...
                        <div className='md:mt-0 px-5 md:col-span-2 place-self-center'>
                            ...
                            <p className='font-sans text-justify text-gray-600 py-2 dark:text-gray-50'>I'm a Software Engineer based out of 🗽 New York. I spend most of my time building and breaking (mostly breaking) software. I love any tool that makes building software more fun. I’ve been lucky to have worked on products that are used by people more than a million times everyday. I'm currently breaking things at <a href='https://www.latch.com/' className='font-medium hover:opacity-75'>Latch Inc</a> as a Sr. iOS Engineer.</p>
